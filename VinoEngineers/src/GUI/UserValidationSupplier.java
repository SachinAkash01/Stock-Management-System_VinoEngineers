...
public class UserValidationSupplier extends javax.swing.JFrame {
    
    Color mouseEnterColor = new Color(255, 0, 0);
    Color mouseExitColor = new Color(204, 0, 0);

    /**
     * Creates new form UserValidationSupplier
     */
    public UserValidationSupplier() {
        initComponents();
    }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (uname.equals("Manager") || uname.equals("Admin")) {
                    ...
                    ManageSupplierUI ui = new ManageSupplierUI();
                    ui.setVisible(true);
                    dispose();
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserValidationSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserValidationSupplier().setVisible(true);
            }
        });
    }
